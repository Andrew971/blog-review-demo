...
const Blog = new Collection('User', schema, {
...
const putItemParam = {
  Item: {
    ...
    Author: 'Andrew SORDIER'
  }
}
Blog.putItem(putItemParam)
// .then(result => console.log('insert 1', result))

const putItemParam2 = {
  Item: {
    Id: '2',
    Title: 'my blog 2',
    Body: ' this is my blog 2',
    Author: 'Andrew SORDIER'
  }
}

Blog.putItem(putItemParam2)

const putItemParam3 = {
  Item: {
    Id: '2',
    Title: 'my blog 3',
    Body: ' this is my blog 3',
    Author: 'Andrew SORDIER'
  }
}

Blog.putItem(putItemParam3)
...
Blog.query(queryParam)
// .then(result => console.log('query 1', result))

const queryParam2 = {
  Index: 'Author_Index',
  Where: {
    HashKey: 'Andrew SORDIER',
    SortKey: 'my blog 2'
  }
}

// Blog.query(queryParam2)
//   .then(result => console.log('query 2', result))
...
Blog.update(updateParam)
  .then(result => console.log('update 1', result))
...
Blog.delete(deleteParam1)
// .then(result => console.log('delete 1', result))

console.log('Blog', Blog.store)